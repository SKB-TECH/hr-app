...
export function toCandidateProfileInput(
  ...
  return {
    ...
    languageProficiencies: details?.languageProficiencies || [],
    preferredProfessionIds: details?.preferredProfessionIds || [],
    preferredCountries: details?.preferredCountries || [],
    preferredEmploymentTypes: details?.preferredEmploymentTypes || [],
    acceptsRemote: details?.acceptsRemote ?? false,
