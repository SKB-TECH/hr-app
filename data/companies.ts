...
export const companiesByCategory: Record<Category, CategoryCompany[]> = {
  Design: [
    ...
    { id: "packer-1", name: "Packer", logo: "/logo/packer.png", jobs: 3 },
    { id: "square-1", name: "Square", logo: "/logo/squre.png", jobs: 3 },
    { id: "divy-1", name: "Divy", logo: "/logo/divy.png", jobs: 3 },
    {
      id: "webflow-cat-1",
      name: "Webflow",
      logo: "/logo/webflowpng.png",
    ...
    { id: "packer-2", name: "Packer", logo: "/logo/packer.png", jobs: 3 },
    { id: "square-2", name: "Square", logo: "/logo/squre.png", jobs: 3 },
    { id: "divy-2", name: "Divy", logo: "/logo/divy.png", jobs: 3 },
    {
      id: "webflow-cat-2",
      name: "Webflow",
      logo: "/logo/webflowpng.png",
    ...
    { id: "packer1", name: "Packer", logo: "/logo/packer.png", jobs: 3 },
    { id: "square2", name: "Square", logo: "/logo/squre.png", jobs: 3 },
    { id: "divy3", name: "Divy", logo: "/logo/divy.png", jobs: 3 },
    {
      id: "webflow-cat4",
      name: "Webflow",
      logo: "/logo/webflowpng.png",
  ...
  Fintech: [
    ...
    { id: "monzo1", name: "Monzo", logo: "", jobs: 2 },
    { id: "wise2", name: "Wise", logo: "", jobs: 3 },
    { id: "chime3", name: "Chime", logo: "", jobs: 4 },
    { id: "brex4", name: "Brex", logo: "", jobs: 3 },
    { id: "affirm5", name: "Affirm", logo: "", jobs: 2 },
  ],
  Hosting: [
    ...
    { id: "cloudflare-2", name: "Cloudflare", logo: "", jobs: 6 },
    { id: "linode-2", name: "Linode", logo: "", jobs: 3 },
    { id: "render-2", name: "Render", logo: "", jobs: 4 },
    { id: "fly-2", name: "Fly.io", logo: "", jobs: 3 },
  ],
  "Business Services": [
