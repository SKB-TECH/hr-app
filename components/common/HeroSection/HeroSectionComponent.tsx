  ...
  return (
    <section className="relative overflow-hidden bg-[#F8F8FD]">
      ...
      <div className="relative z-10 mx-auto grid min-h-[560px] grid-cols-1 px-4 pt-10 sm:px-6 md:min-h-[760px] md:px-[128px] md:pt-[90px]">
        <div className="absolute inset-x-0 top-24 z-20 mx-auto w-full max-w-6xl px-4 sm:px-6 md:top-32">
          <div className="flex  flex-col justify-center pb-10 md:pb-16 ">
            ...
            {/* Search Form */}
            <div className="relative z-30 mt-6 flex w-full flex-col border border-[#D6DDEB] bg-white p-4 shadow-[0_16px_40px_rgba(37,50,75,0.08)] md:mt-9 md:max-w-[850px] md:flex-row">
