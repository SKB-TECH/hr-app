...
export default function HeroSectionComponent() {
    return (
        <section className="relative overflow-hidden bg-[#F8F8FD]">
            ...
            <div className="relative z-10 mx-auto grid min-h-[560px] max-w-[1440px] grid-cols-1 px-4 pt-10 sm:px-6 md:min-h-[760px] md:grid-cols-[620px_1fr] md:px-[128px] md:pt-[90px]">
              ...
              5000+ Jobs
              <span className="absolute -bottom-2 left-0 h-[10px] w-full rounded-full border-b-[6px] border-[#26A4FF] md:-bottom-5 md:h-[16px] md:border-b-[10px]" />
            </span>
                    </h1>
                    ...
                    <div className="mt-6 flex w-full flex-col bg-white p-4 shadow-[0_16px_40px_rgba(37,50,75,0.08)] md:mt-9 md:w-[850px] md:flex-row">
                        <div className="flex w-full items-center gap-3 border-b border-[#D6DDEB] px-2 py-2 md:w-[310px] md:border-b-0 md:border-r md:px-4 md:py-0">
                            ...
                            <Input
                                ...
                                className="h-10 border-0 px-0 text-sm shadow-none placeholder:text-[#B8C0CC] focus-visible:ring-0 md:h-12 md:text-base"
                            />
                        </div>

                        <div className="flex w-full items-center gap-3 border-b border-[#D6DDEB] px-2 py-2 md:w-[270px] md:border-b-0 md:border-r md:px-4 md:py-0">
                            <MapPin size={20} className="shrink-0 text-[#25324B] md:size-[25px]" />
                            <Input
                                placeholder="Florence, Italy"
                                className="h-10 border-0 px-0 text-sm shadow-none placeholder:text-[#25324B] focus-visible:ring-0 md:h-12 md:text-base"
                            />
                            <ChevronDown size={14} className="shrink-0 text-[#7C8493] md:size-4" />
                        </div>

                        <Button className="mt-3 h-12 rounded-none bg-[#4640DE] text-sm font-bold hover:bg-[#3730c9] md:mt-0 md:h-[72px] md:flex-1 md:text-lg">
                            Search my job
                        </Button>
                    </div>
