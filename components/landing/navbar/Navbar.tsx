    ...
    <div className="bg-white sticky top-0 z-50">
     ...
     <div className="flex items-center gap-10">
      ...
      <div className="flex items-center gap-2.5">
        <LogoIcon />
        <span className="text-xl font-extrabold text-indigo-600 tracking-tight">JobHuntly</span>
      </div>

      {/* Navigation Links */}
      <div className="hidden md:flex items-center gap-5">
        <a href="f" className="text-sm font-medium text-gray-700 hover:text-indigo-600 transition-colors">
          Find Jobs
        </a>
        <a href="#" className="text-sm font-medium text-gray-700 hover:text-indigo-600 transition-colors">
          Browse Companies
        </a>
      </div>
