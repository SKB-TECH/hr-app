...
export default function CountrySelect({id,value,onChange,placeholder="Sélectionner un pays"}:{id?:string;value:string;onChange:(name:string)=>void;placeholder?:string}){
