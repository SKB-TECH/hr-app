    ...
    <div className='grid grid-cols-1 gap-4 sm:grid-cols-2'>
      ...
      <div>
        ...
        <select
          ...
          className='w-full cursor-pointer rounded-none border border-gray-300 bg-white px-4 py-3 outline-none transition focus:border-brand disabled:cursor-not-allowed disabled:bg-gray-50 disabled:text-gray-400'
          value={cityValue}
        ...
        >
          ...
          {cityValue && !cities.includes(cityValue) && (
